            ...
            <div className="p-3 rounded-lg w-[60%] mx-auto mt-20 bg-sky-400">
                <div className="relative w-full p-2 h-[100px]">
                    <div className="absolute top-0 left-0 w-full h-[100px] -z-10">
                        <Image className="w-full h-full" src={"/pattern.png"} alt="" width={300} height={200} />
                    </div>
                ...
                <div className="flex flex-col gap-[3px] p-3">
                    {keysValues.map((item, index) => {
                        if (item[0] === "city_mpg" || item[0] === "combination_mpg" || item[0] === "highway_mpg")
                            return null
                        return <div key={index} className="flex items-center justify-between text-sm text-white">
                            <p> {item[0]} </p>
                            <p> {item[1]} </p>
                        </div>
                    })}
